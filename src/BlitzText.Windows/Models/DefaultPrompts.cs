...
{
    public const string Improve = "Formuliere den Text klar, natuerlich und gut lesbar. Fuege fehlende Leerzeichen zwischen Woertern ein und stelle normale Wortabstaende sowie sinnvolle Satzzeichen her. Entferne Fuellwoerter und unnoetige Wiederholungen, ohne den Ton oder die Aussage zu veraendern. Nutze Abschnitte oder Listen nur, wenn sie das Verstaendnis verbessern.";
    ...
    public const string ImproveEnglish = "Make the text clear, natural, and easy to read. Insert missing spaces between words and restore normal word spacing and sensible punctuation. Remove filler and unnecessary repetition without changing its tone or message. Use paragraphs or lists only when they improve comprehension.";
